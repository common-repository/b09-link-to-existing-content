...
= WARNING: Admin tweaks of this plugin are deprecated starting with WordPress v4.5! =
Read more about this in the Changelog Tab.
...
= 2.2 =
* **Admin Scripts are deprecated starting with WordPress v4.5!** This is due to the new link handling in the editor panel. If you are using the plugin's link shortcodes functionality, just leave the plugin installed, or copy the shortcode handling code to your `functions.php`.
